...
build-container:
	docker build .. -t "jobinjosem/$(svc_name):$(IMAGE_TAG)" --build-arg svc_name=$(svc_name)

build-multi-arch:
	docker buildx build .. -t "jobinjosem/$(svc_name):$(IMAGE_TAG)" --build-arg svc_name=$(svc_name) \
