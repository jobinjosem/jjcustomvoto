...
func (a *Api) HealthzHandler(w http.ResponseWriter, r *http.Request) {
	if atomic.LoadInt32(&healthy) == 1 {
		a.JSONResponse(w, r, map[string]string{"status": "OK"})
		return
	}
...
func (a *Api) EnableReadyHandler(w http.ResponseWriter, r *http.Request) {
...
// @Success 202 {string} string "OK"
func (a *Api) DisableReadyHandler(w http.ResponseWriter, r *http.Request) {
